  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) => SingleChildScrollView(
        ...
        child: Column(
          children: [
            SectionCard(title: 'Store Profile', child: StoreProfileForm(store: store, onSaved: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Store profile saved'))))),
